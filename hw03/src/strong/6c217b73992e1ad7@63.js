...
function _userdata1(FileAttachment){return(
FileAttachment("UserData-1.json").json()
)}

function _bgColor(Inputs){return(
Inputs.color({ label: "background color", value: "#51A8DD" })
)}

function _strokeColor(Inputs){return(
Inputs.color({ label: "stroke color", value: "#2E5C6E" })
)}
...
function _LivePlace_column(userdata1,LivePlace){return(
userdata1.map(row => row[LivePlace])
)}

function _LivePlace(userdata1){return(
Object.keys(userdata1[0])[0]
)}
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("userdata1")).define("userdata1", ["FileAttachment"], _userdata1);
  ...
  main.variable(observer("LivePlace_column")).define("LivePlace_column", ["userdata1","LivePlace"], _LivePlace_column);
  main.variable(observer("LivePlace")).define("LivePlace", ["userdata1"], _LivePlace);
